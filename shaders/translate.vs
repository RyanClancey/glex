...
mat4 rotate_y(float theta)
{
    return mat4(
        ...
        vec4(0.0, 1, 0, 0.0),
        vec4(-sin(theta), 0, cos(theta), 0.0),
        vec4(0.0, 0.0, 0.0, 1.0)
    );
}
...
void main() {
      gl_Position = projection(radians(45.0), 4.0/3.0, -0.1, -1000.0)
                      ...
                      * rotate_x(radians(45.0)) //change angle of viewing on x-axis
		      * rotate_y(radians(45.0)) //change angle of viewing on y-axis
                      * vec4(position, 1.0f);
      frag_color = vec3(0.0, 1.0, 1.0); // cyan
}
